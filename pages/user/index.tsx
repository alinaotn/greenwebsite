    ...
    <div>
      ...
      <div className="z-10 p-12 relative">
        ...
        <div className="flex items-center flex-wrap flex-col">
          <h1 className="md:w-3/5 md:mt-24">What users can do:</h1>
          ...
          <h1 className="md:w-3/5 mt-8">1. Reduce video streaming</h1>
          <span className="md:w-3/5 text-justify mt-4">
          ...
          <h1 className="md:w-3/5 mt-8">2. Reduce cloud usage</h1>
          <span className="md:w-3/5 text-justify mt-4">
          ...
          <h1 className="md:w-3/5 mt-8">3. Take care of your hardware</h1>
          <span className="md:w-3/5 text-justify mt-4">
          ...
          <h1 className="md:w-3/5 mt-8">4. Surf with care</h1>
          <div className="md:w-3/5 mt-4 flex flex-col md:flex-row">
            <span className="md:w-1/2 text-justify mb-8 md:mb-0 md:mr-20">
          ...
          <h1 className="md:w-3/5 mt-8">4. Start a petition</h1>
