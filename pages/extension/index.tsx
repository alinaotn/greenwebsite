    ...
    <div>
      ...
      <div className="z-10 p-12 relative">
        ...
        <div className="flex items-center  flex-wrap flex-col">
          ...
          <h1 className="w-4/5 md:w-3/5  mt-8">1. Green Hosting </h1>
          <span className="w-4/5 md:w-3/5  text-justify mt-4">
          ...
          <h1 className="w-4/5 md:w-3/5  mt-8">2. Page Speed</h1>
          <span className="w-4/5 md:w-3/5  text-justify mt-4">
          ...
          <h1 className="w-4/5 md:w-3/5  mt-8">3. HTTP Requests</h1>
          <span className="w-4/5 md:w-3/5  text-justify mt-4">
